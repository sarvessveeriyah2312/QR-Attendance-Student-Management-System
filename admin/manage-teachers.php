...
$sql="delete from tblteacher where TID=:rid";
...
<html lang="en">
  <head>
    ...
    <title>Student Monitoring System | Manage Teachers</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
     ...
     <?php include_once('includes/header.php');?>
      ...
      <div class="container-fluid page-body-wrapper">
       ...
       $ret = "SELECT TID FROM tblteacher";
$query1 = $dbh -> prepare($ret);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$total_rows=$query1->rowCount();
$total_pages = ceil($total_rows / $no_of_records_per_page);
$sql="SELECT * from tblteacher LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->Address);?> <?php  echo htmlentities($row->Section);?></td>
                            ...
                            <td>
                              <div><a href="edit-teacher-detail.php?editid=<?php echo htmlentities ($row->TID);?>"><i class="icon-eye"></i></a>
                                                | <a href="manage-teachers.php?delid=<?php echo ($row->TID);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
