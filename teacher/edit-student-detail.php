...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $eid=$_GET['editid'];
$sql="update tblstudent set StudentName=:stuname,StudentEmail=:stuemail,StudentClass=:stuclass,Gender=:gender,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address,UserName=:uname,Password=:password where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>Student  Monitoring System | Students Profile</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Students Profile</h4>
                   
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <?php
$eid=$_GET['editid'];
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid, tblstudent.StudentClass,tblstudent.FatherName,tblstudent.MotherName,tblstudent.ContactNumber,tblstudent.AltenateNumber,tblstudent.Address,tblstudent.UserName,tblstudent.Password,tblstudent.Gender,tblstudent.DOB,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission  from tblstudent where tblstudent.ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                      ...
                      <div class="form-group">
                        ...
                        <select  name="stuclass" class="form-control" required='true'>
                          <option value="<?php echo htmlentities($row->StudentClass);?>"></option>
                         <?php 
