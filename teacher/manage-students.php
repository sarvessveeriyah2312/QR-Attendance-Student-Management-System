...
<html lang="en">
  <head>
    ...
    <title>Student Monitoring System | Manage Students</title>
    <!-- plugins:css -->
...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentClass,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.DateofAdmission  from tblstudent   LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-student-detail.php?editid=<?php echo htmlentities ($row->sid);?>"><i style="margin-left: 15px;"class="icon-eye"></i></a>
                                      </div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
