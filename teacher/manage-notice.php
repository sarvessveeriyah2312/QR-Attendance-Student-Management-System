...
<html lang="en">
  <head>
    ...
    <title>Student  Monitoring System |Manage Notice</title>
    <!-- plugins:css -->
...
$sql="SELECT tblclass.ID,tblclass.ClassName,tblnotice.NoticeTitle,tblnotice.CreationDate,tblnotice.ClassId,tblnotice.ID as nid from tblnotice join tblclass on tblclass.ID=tblnotice.ClassId LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-notice-detail.php?editid=<?php echo htmlentities ($row->nid);?>"><i style="margin-left:15px" class="icon-eye"></i></a>
