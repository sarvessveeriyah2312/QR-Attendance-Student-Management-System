...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $notmsg=$_POST['notmsg'];
$sql="insert into tblmessages(Subject,outgoing_msg_id,msg)values(:nottitle,:classid,:notmsg)";
...
$query->bindParam(':notmsg',$notmsg,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Messages has been send.")</script>';
...
<html lang="en">
  <head>
    ...
    <title>Student  Monitoring System | Communication </title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Send Message</h4>
...
{          
    ?>  
<option value="<?php echo htmlentities($row1->NameFather);?>"><?php echo htmlentities($row1->NameFather);?></option>
 <?php } ?> 
                        </select>
                      </div>
                      <div class="form-group">
