...
$sql="SELECT tblparents.StuID, tblattendance.StuID,tblattendance.Attendance,tblattendance.date_created from tblattendance join tblparents on tblparents.StuID=tblattendance.StuID where tblparents.PID= :sid";
