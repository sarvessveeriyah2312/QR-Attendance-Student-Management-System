...
{
$parentsid=$_SESSION['sturecmsaid'];
$cpassword=md5($_POST['currentpassword']);
$newpassword=md5($_POST['newpassword']);
$sql ="SELECT PID FROM tblparents WHERE PID=:parentsid and Password=:cpassword";
$query= $dbh -> prepare($sql);
$query-> bindParam(':parentsid', $parentsid, PDO::PARAM_STR);
...
if($query -> rowCount() > 0)
{
$con="update tblparents set Password=:newpassword where PID=:parentsid";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':parentsid', $parentsid, PDO::PARAM_STR);
...
<html lang="en">
  <head>
    ...
    <title>Student  Monitoring System | Change Password</title>
    <!-- plugins:css -->
