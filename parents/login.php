...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT PID FROM tblparents WHERE UserName=:username and Password=:password";
...
$_SESSION['sturecmsaid']=$result->PID;
}
...
<html lang="en">
  <head>
    ...
    <title>Student  Monitoring System | Login Page</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Hello! Parents. Let's get started</h4>
