...
<html lang="en">
  <head>
    ...
    <title>Student Monitoring System | Public Notice</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Public Notice </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0"> Public Notice</h4>
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-public-notice-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i style="margin-left:15px"class="icon-eye"></i></a>
